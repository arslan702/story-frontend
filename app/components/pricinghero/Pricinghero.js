    ...
    return (
        <div className='lg:relative overflow-hidden flex flex-col bg-[#F5FBFF]  md:pb-[200px]'>
            ...
            <div className='lg:relative font-bold mx-3 md:ml-[70px] mt-[10] font-Fredoka  flex flex-col '>
                <div className='lg:absolute right-0 z-[1] xl:top-[-107px]'>
                ...
                {/* heading */}
                <div className='z-[6] mt-20 flex text-[25px] md:text-[40px] lg:text-[48px] flex-col leading-none'>
                    <div className='text-[#000000]'>
                        <p>Create Your Personalized</p>
                    </div>
                ...
                {/* para */}
                <div className='z-[6] p-2 md:p-0 mt-[15px] md:mt-[40px] flex flex-col gap-y-2'>
                    <div className='text-[#575757] text-[14px] md:text-[16px] font-normal font-Poppins'>
                        <p className='z-[6]'>
                            Create a unique children&apos;s story with our easy-to-use ai storybook maker. <br className='hidden lg:inline' />
                            Our personalized children&apos;s books are fully customized with original characters, <br className='hidden lg:inline' />
